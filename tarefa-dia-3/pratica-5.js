...
let VendasSGorjeta = 0
let i = 0

while (i < receita.length) {
    VendasSGorjeta += receita[i].valor
    i++
}

console.log("Valor total de vendas sem gorjeta: ", VendasSGorjeta)

/* ----------------------------------------------------------------------------- */

/* PROBLEMA 2: Qual o valor total de vendas incluindo a gorjeta? --------------- */
//COLOQUE SUA SOLUÇÃO AQUI
let VendasCGorjeta = 0
i = 0

while (i < receita.length) {
    VendasCGorjeta += receita[i].valor + receita[i].gorjeta
    i++
}

console.log("Valor total de vendas com gorjeta: ", VendasCGorjeta)
